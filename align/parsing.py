...
def parse_args():
    ...
    parser.add_argument('--regularization_weights', type=int, nargs='3', default=[1, 5, 50], help='regularization weight at each iteration. Each iteration is at a different downsample layer.')
